...
for($x=0;$x<count($herojson["BTC"]["next_days"]);$x++){
    ...
    array_push($date_predic10,$herojson["BTC"]["next_days"][$x]["index"]);
    array_push($val_predic10,$herojson["BTC"]["next_days"][$x]["values"]);
}
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Bitcoin Price Predictions</h2>
                                <nav class="bradcaump-inner">
                                    <a class="breadcrumb-item" href="index.php">Home</a>
                                    <span class="brd-separetor">/</span>
                                    <span class="breadcrumb-item active">Bitcoin</span>
                                </nav>
                            </div>
                        </div>
                    </div>
...
//$val_ac100=[];
     ...
     //console.log(pddate[pddate.length-1]);
     ...
     <script>
        ...
        var myChart = Highcharts.chart('containerr', {
            ...
            series: [
                ...
                stops: [
                    [0, 'rgb(235,120,16,0.7)'],
                    [1, 'rgb(235,122,175,0.7)']
                ]
                }
                ...
                stops: [
                    [0, 'rgb(103,124,231,0.5)'],
                    [1, 'rgb(117,77,165,0.5)' ]
                ]
                }
            }]
        });
