...
$val_predic100=[];
$val_ac100=[];
for($x=0;$x<count($herojson["BSV"]["next_days"]);$x++){
    
    array_push($date_predic10,$herojson["BSV"]["next_days"][$x]["index"]);
    array_push($val_predic10,$herojson["BSV"]["next_days"][$x]["values"]);
}

$datelast="";

for($x=0;$x<count($herojson["BSV"]["actual"]);$x++){
    
    array_push($date_acval,$herojson["BSV"]["actual"][$x]["time"]);
    array_push($val_predic100,$herojson["BSV"]["actual"][$x]["close"]);
    array_push($val_ac100,$herojson["BSV"]["predicted"][$x]["values"]);
    if($x==count($herojson["BSV"]["actual"])-1){
...
<head>
  ...
  <title>BITCOIN SV PRICE PREDICTIONS
</title>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Bitcoin SV Price Predictions</h2>
                                <nav class="bradcaump-inner">
                                    <a class="breadcrumb-item" href="index.php">Home</a>
                                    <span class="brd-separetor">/</span>
                                    <span class="breadcrumb-item active">BitcoinSV</span>
                                </nav>
                            </div>
                        </div>
                    </div>
