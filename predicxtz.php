...
$val_predic100=[];
$val_ac100=[];
for($x=0;$x<count($herojson["XTZ"]["next_days"]);$x++){
    
    array_push($date_predic10,$herojson["XTZ"]["next_days"][$x]["index"]);
    array_push($val_predic10,$herojson["XTZ"]["next_days"][$x]["values"]);
}

$datelast="";

for($x=0;$x<count($herojson["XTZ"]["actual"]);$x++){
    
    array_push($date_acval,$herojson["XTZ"]["actual"][$x]["time"]);
    array_push($val_predic100,$herojson["XTZ"]["actual"][$x]["close"]);
    array_push($val_ac100,$herojson["XTZ"]["predicted"][$x]["values"]);
    if($x==count($herojson["XTZ"]["actual"])-1){
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Tezos Price Predictions</h2>
                                <nav class="bradcaump-inner">
                                    <a class="breadcrumb-item" href="index.php">Home</a>
                                    <span class="brd-separetor">/</span>
                                    <span class="breadcrumb-item active">XTZ</span>
                                </nav>
                            </div>
                        </div>
                    </div>
