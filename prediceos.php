...
$val_predic100=[];
$val_ac100=[];
for($x=0;$x<count($herojson["EOS"]["next_days"]);$x++){
    
    array_push($date_predic10,$herojson["EOS"]["next_days"][$x]["index"]);
    array_push($val_predic10,$herojson["EOS"]["next_days"][$x]["values"]);
}

$datelast="";

for($x=0;$x<count($herojson["EOS"]["actual"]);$x++){
    
    array_push($date_acval,$herojson["EOS"]["actual"][$x]["time"]);
    array_push($val_predic100,$herojson["EOS"]["actual"][$x]["close"]);
    array_push($val_ac100,$herojson["EOS"]["predicted"][$x]["values"]);
    if($x==count($herojson["EOS"]["actual"])-1){
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">EOS Price Predictions</h2>
                                <nav class="bradcaump-inner">
                                    <a class="breadcrumb-item" href="index.php">Home</a>
                                    <span class="brd-separetor">/</span>
                                    <span class="breadcrumb-item active">EOS</span>
                                </nav>
                            </div>
                        </div>
                    </div>
