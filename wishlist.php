...
<ul class="dropdown-menu">          
     ...
     <li>  <a class="large" data-value="option1" tabIndex="-1"> <input type="checkbox" name="Curr[]" id="defafult" value="btc">&nbsp;Bitcoin</a></li>

        <li> <a class="large" data-value="option1" tabIndex="-1"> <input type="checkbox" name="Curr[]" id="defafult" value="eth">&nbsp;Ethereum</a></li>

       <li>  <a class="large" data-value="option1" tabIndex="-1">  <input type="checkbox" name="Curr[]" id="defafult" value="xrp">&nbsp;Ripple</a></li>

       <li> <a class="large" data-value="option1" tabIndex="-1">  <input type="checkbox" name="Curr[]" id="defafult" value="bch">&nbsp;Bitcoin Cash</a></li>
        
       <li>  <a class="large" data-value="option1" tabIndex="-1"> <input type="checkbox" name="Curr[]" id="defafult" value="usdt">&nbsp;Monero</a></li>
        
        <li> <a class="large" data-value="option1" tabIndex="-1">  <input type="checkbox" name="Curr[]" id="defafult" value="ltc">&nbsp;Litecoin</a></li>
      
        <li>  <a class="large" data-value="option1" tabIndex="-1">  <input type="checkbox" name="Curr[]" id="defafult" value="bsv">&nbsp;Bitcoin SV</a></li>
        
       <li>  <a class="large" data-value="option1" tabIndex="-1"> <input type="checkbox" name="Curr[]" id="defafult" value="bnb">&nbsp;Binance Coin</a></li>
      
       <li>  <a class="large" data-value="option1" tabIndex="-1">  <input type="checkbox" name="Curr[]" id="defafult" value="eos">&nbsp;EOS Coin</a></li>
      
        <li> <a class="large" data-value="option1" tabIndex="-1">  <input type="checkbox" name="Curr[]" id="defafult" value="xtz">&nbsp;Tezos</a></li>
      <div >
<br><center>
      <input class="btn btn-primary" type="submit"></center>
      </div>
